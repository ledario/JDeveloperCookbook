...
public class DepartmentsRowImpl extends ExtViewRowImpl {
    ...
    public DepartmentImpl getDepartment() {
        return (DepartmentImpl)getEntity(0);
    }
